...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-link.active { color: var(--black); background: var(--active-bg); font-weight: 400; }
        .nav-link svg { width: 18px; height: 18px; flex-shrink: 0; }
        .nav-link.active svg { color: var(--black); }
        ...
        /* ─── READ-ONLY INDICATOR (Direktur / Komisaris) ──── */
        ...
        .readonly-indicator svg { flex-shrink: 0; color: var(--text-muted); }
        ...
        .stat-grid  { display: grid; grid-template-columns: repeat(4, 1fr); gap: 0; margin-bottom: 40px; }
        .stat-card {
            background: var(--white); border: 1px solid var(--border);
        ...
        .stat-sub .up { color: var(--black); font-weight: 700; font-size: 12px; }
        ...
        .badge {
            ...
            padding: 4px 12px; font-size: 10px; font-weight: 400;
        ...
        .badge-draft { background: var(--white); border: 1px solid var(--border); color: var(--text-muted); }
        .badge-process { background: #333333; color: var(--white); }
        ...
        .form-control:focus { border-color: var(--black); box-shadow: none; }
        select.form-control {
            appearance: none;
        ...
        /* ─── DETAIL ITEMS ────────────────────────────── */
        .detail-label { font-size: 11px; font-weight: 700; letter-spacing: 0.6px; text-transform: uppercase; color: var(--text-muted); margin-bottom: 4px; }
        ...
        .modal {
            background: var(--white); width: 425px; max-width: 95vw;
        ...
        .page-btn {
            ...
            font-size: 16px; cursor: pointer; font-family: var(--font); color: var(--text);
        }
...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="po_list.php" class="nav-link <?= in_array($current_page??'', ['po_list','po_detail','po_edit','po_status']) ? 'active' : '' ?>">
        ...
        <a href="po_create.php" class="nav-link <?= ($current_page??'')==='po_create' ? 'active' : '' ?>">
        ...
        <?php endif; ?>
        <a href="po_riwayat.php" class="nav-link <?= ($current_page??'')==='po_riwayat' ? 'active' : '' ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>
            Riwayat PO
        </a>
        <?php if (current_role() === 'admin'): ?>
        <a href="user_management.php" class="nav-link <?= ($current_page??'')==='user_management' ? 'active' : '' ?>">
            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>
            Manajemen Pengguna
        </a>
        <?php endif; ?>
    </nav>
    <?php if (in_array(current_role(), ['direktur','komisaris'])): ?>
        ...
        <div class="topbar-right">
            <div class="topbar-user">
                <div class="topbar-user-info">
                    <span class="topbar-user-name"><?= e(current_username()) ?></span>
                    <span class="topbar-user-role"><?= e(current_role()) ?></span>
                </div>
                <div class="topbar-avatar"><?= strtoupper(substr(current_username(),0,1)) ?></div>
            </div>
        </div>
    </div>
    <?php endif; ?>
